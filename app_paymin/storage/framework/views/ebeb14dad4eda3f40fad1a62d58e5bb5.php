...
<body>
    ...
    <main class="flex items-center justify-between h-screen bg-[#E6EEFD] overflow-hidden font-poppins">
            ...
            <div class="flex gap-4 py-6 w-full">
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($outOfStock); ?> Items</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($lowStock); ?> Items</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalProducts); ?> Items</p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex flex-col items-center w-full h-full">
                                ...
                                <div class="flex flex-col items-center justify-center w-full mt-auto">
                                    ...
                                    <p class="text-[11pt] text-gray-500 mt-1 mb-2.5">
                                        Rp. <?php echo e($p->price); ?> <span class="mx-1">|</span> <?php echo e($p->stock); ?> Stock
                                    </p>
                                </div>
        ...
        <div class="fixed inset-0 bg-black/25 backdrop-blur-md bg-opacity-50 flex justify-center items-center z-50 animate-fadeIn hidden"
            id="modalDeleteItem">
            <!-- Modal Container -->
            <form method="POST" action="<?php echo e(route('SysDeleteItem')); ?>">
                <?php echo csrf_field(); ?>

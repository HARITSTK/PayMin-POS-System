...
<body onclick="window.location.href='<?php echo e(route('Auth')); ?>'" class="cursor-pointer">
...
</html><?php /**PATH C:\laragon\www\app_paymin\resources\views/fpay.blade.php ENDPATH**/ ?>
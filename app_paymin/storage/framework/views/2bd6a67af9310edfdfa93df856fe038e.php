    ...
    <main class="flex items-center justify-between h-screen bg-[#E6EEFD] p-5 font-poppins font-light">
        ...
        <section
            ...
            <div class="flex flex-1 flex-col items-center justify-center relative z-10 w-auto h-auto">
                ...
                <form id="loginForm" class="space-y-4 flex flex-col items-center" action="<?php echo e(route('SysLogin')); ?>"
                    method="POST">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\app_paymin\resources\views/authpage/loginpay.blade.php ENDPATH**/ ?>
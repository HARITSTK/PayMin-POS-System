      ...
      >
        ...
        <nav id="navbar" class="bg-white h-full overflow-hidden w-[7.2rem] min-w-[7.2rem] p-5 shadow-4xl rounded-r-4xl">
            <ul id="navbar-list" class="flex flex-col h-full w-full relative z-10">
                ...
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('HomeKaryawan')); ?>" class="flex flex-col items-center justify-center">
                        <i class="fa fa-home fa-2x"></i>
                ...
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('OrderKaryawan')); ?>" class="flex flex-col items-center justify-center">
                        <i class="fa fa-cart-plus fa-2x"></i>
                        <p class="text-sm">Orders</p>
                    </a>
                </li>
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('ReportKaryawan')); ?>" class="flex flex-col items-center justify-center">
                        <i class="fa fa-file-text-o fa-2x"></i>
                        <p class="text-sm">Report</p>
                    </a>
                </li>
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('ItemKaryawan')); ?>" class="flex flex-col items-center justify-center">
                        <i class="fa fa-th fa-2x"></i>
                        <p class="text-sm">Items</p>
                    </a>
                </li>
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('MemberKaryawan')); ?>" class="flex flex-col items-center justify-center">
                ...
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="<?php echo e(route('SettingKaryawan')); ?>" class="flex flex-col items-center justify-center">
                        <i class="fa fa-cog fa-2x"></i>
                        <p class="text-sm">Settings</p>
                    </a>
                </li>
        ...
        <section class="h-full w-full p-11 box-border overflow-y-auto">
            ...
            <div class="mb-8">
                <h1 class="text-[36pt] font-bold text-[#353535]">
                    <span class="font-medium">Welcome</span> <?php echo e($user->name); ?> !
                </h1>
            </div>
            ...
            <div class="grid grid-cols-4 grid-rows-[0.5fr_1fr_0.5fr_1fr_0.2fr] gap-6">
                ...
                <div
                    ...
                    <div class="flex w-full justify-between items-center mt-auto">
                        <div class="flex flex-col justify-between mb-2">
                            <p class="font-bold text-md text-textColor">Rp.
                                <?php echo e(number_format($admissionFee, 0, ',', '.')); ?></p>
                ...
                <div
                    ...
                    <div class="flex w-full justify-between items-center mt-auto">
                        <div class="flex flex-col justify-between mb-2">
                            <p class="font-bold text-md text-textColor"><?php echo e(number_format($TotalItems, 0, ',', '.')); ?>
                ...
                <div
                    ...
                    <div class="flex w-full justify-between items-center mt-auto">
                        <div class="flex flex-col justify-between mb-2">
                            <p class="font-bold text-md text-textColor">
                                <?php echo e(number_format($TotalCustomers, 0, ',', '.')); ?></p>
                            <p class="text-gray-400 font-medium">Last Month</p>
                        </div>
                        <div
                            class="text-sm text-[#067647] bg-[#E6EEFD] h-[30%] rounded-2xl flex items-center justify-center gap-2 p-3">
                ...
                <div
                    ...
                    <div class="grid grid-cols-2 grid-rows-2 gap-2">
                        <?php $__currentLoopData = $lowStocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <span class="text-gray-500 text-[10pt] w-20 text-center mb-2"><?php echo e($ls->name); ?></span>
                            <span class="font-bold text-l text-[#353535]"><?php echo e($ls->stock); ?>/span>
                                <div
                        ...
                        <div class="grid grid-cols-3 grid-rows-2 gap-2 p-2 h-full">
                            ...
                            <div class="flex flex-col items-center bg-white rounded-lg shadow-4xl w-auto h-full p-3">
                                ...
                                <div class="flex flex-col items-center w-full my-auto">
                                    <span class="text-gray-500 text-[15pt] mb-1 font-medium"><?php echo e($p->name); ?></span>
                                    <span class="font-bold text-[13pt] text-[#353535]"><?php echo e($p->price); ?></span>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between gap-3">
                        <?php $__currentLoopData = $salesGrowth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div class="flex flex-col">
                                <span class="text-gray-500 text-sm"><?php echo e($sg->name); ?></span>
                                <span class="font-bold text-[#353535]"><?php echo e($sg->stock); ?></span>
                            </div>
                            <div
...
</html><?php /**PATH C:\laragon\www\app_paymin\resources\views/karyawanpage/home.blade.php ENDPATH**/ ?>
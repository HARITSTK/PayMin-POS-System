        ...
        <section class="h-full w-full p-11 box-border overflow-y-auto">
            ...
            <div class="flex items-center w-full h-full p-4 gap-12">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 flex-2 mx-auto flex flex-col h-full w-full"
                    ...
                    <div class="flex h-auto w-full mx-5 items-center">
                        ...
                        <div class="flex flex-col justify-center ml-4 text-lg">
                            ...
                            <p class="text-gray-500">Last updated: <?php echo e($user->updated_at); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-center ml-4 text-lg">
                        ...
                        <p class="text-gray-500"><?php echo e($user->bio ?? 'Bio is empty'); ?></p>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 h-full flex-2 shadow-4xl hidden" id="security">
                    ...
                    <form class="space-y-4" action="<?php echo e(route('SysUpdatePassword')); ?>" method="post">
                        <?php echo csrf_field(); ?>
            ...
            <div class="fixed inset-0 bg-black/25 backdrop-blur-md justify-center items-center z-50 animate-fadeIn hidden"
                ...
                <div
                    ...
                    <form action="<?php echo e(route('SysEditProfile')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea type="text" name="bio"
                                class="mt-1 p-1 block w-[23vw] border border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary"><?php echo e($user->bio); ?>
...
</html><?php /**PATH C:\laragon\www\app_paymin\resources\views/karyawanpage/setting.blade.php ENDPATH**/ ?>
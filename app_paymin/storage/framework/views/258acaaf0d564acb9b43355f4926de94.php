            ...
            <div class="flex gap-4 py-6 w-full">
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-800">Rp. <?php echo e(number_format($TotalIncome, 0, ',', '.')); ?></p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e(number_format($TotalCustomers, 0, ',', '.')); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table-auto w-full" id="dataTable">
                        ...
                        <tbody class="" id="tableBody">
                            ...
                            <tr class="border-b border-tertiary h-[3rem] text-center" data-date="2025-05-23"
                                ...
                                <td class="p-4"><?php echo e($sl->payment); ?></td>
                                <td class="p-4">

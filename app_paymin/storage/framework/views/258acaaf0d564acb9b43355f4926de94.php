...
<body>
    ...
    <main class="flex items-center justify-between h-screen font-poppins box-border bg-[#E6EEFD]">
                                ...
                                <td class="p-3">
                                    <div class="flex justify-center">
                                        <button
                                            ...
                                            onclick="showTransactionModal(this)" data-id="<?php echo e($sl->id); ?>"
                                            data-user="<?php echo e($sl->user->name ?? '-'); ?>"
                                            data-date="<?php echo e(\Carbon\Carbon::parse($sl->sale_date)->format('d/m/Y')); ?>"
                                            data-customer="<?php echo e($sl->customer->name ?? '-'); ?>" data-items='<?php echo json_encode($sl->saleItems->map(fn($item) => [
                                            "name" => $item->product->name ?? ' Unknown', "qty"=> $item->quantity
                                            ]), 512) ?>'
                                            data-payment="<?php echo e($sl->payments->first()->payment_method ?? '-'); ?>"
                                            data-type="<?php echo e(ucfirst(str_replace('_', ' ', $sl->type))); ?>"
                                            data-amount="Rp<?php echo e(number_format($sl->total, 0, ',', '.')); ?>">
                                        ...
                                        <button
                                            ...
                                            onclick="setDeleteTransaction(<?php echo e($sl->id); ?>)">
                                            <span class="material-symbols-outlined">
                                                cancel
                                            </span>
                                        </button>
        ...
        <!-- Modal Delete Item -->
        <form action="<?php echo e(route('transaction.delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="fixed inset-0 bg-black/25 backdrop-blur-md justify-center items-center z-50 animate-fadeIn hidden"
                ...
                <div
                    ...
                    <div class="mt-4 flex flex-col gap-y-2 py-2">
                        ...
                        <p class="text-lg text-gray-800">
                            Deleting Transaction ID #<span class="font-bold" id="deleteTransactionText">000009</span>.
        ...
        <div class="fixed inset-0 bg-black/25 backdrop-blur-md justify-center items-center z-50 animate-fadeIn hidden"
            ...
            <div
                ...
                <p class="text-center font-semibold text-gray-800 mb-4">
                    Transaction ID <span class="font-bold" id="modalTransId">#00000009</span>
                </p>
                ...
                <div class="space-y-4 text-sm text-gray-800">
                    <div class="flex justify-between border-b pb-1">
                        ...
                        <span class="font-medium" id="modalUser">Davetron Aljabar</span>
                    </div>
                    <div class="flex justify-between border-b pb-1">
                        <span>Date Transaction</span>
                        <span class="font-medium" id="modalDate">23/05/2025</span>
                    </div>
                    <div class="flex justify-between border-b pb-1">
                        <span>Nama Costumer</span>
                        <span class="font-medium" id="modalCustomer">Dave Aljabar</span>
                    </div>
                    <div class="border-b pb-1">
                        <span class="block mb-1">Item Name</span>
                        <div class="text-right leading-tight font-medium" id="modalItems">
                    ...
                    <div class="flex justify-between border-b pb-1">
                        ...
                        <span class="font-medium" id="modalPayment">Cash</span>
                    </div>
                    <div class="flex justify-between border-b pb-1">
                        <span>Type Orders</span>
                        <span class="font-medium" id="modalType">Go Away</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Amount</span>
                        <span class="font-medium" id="modalAmount">Rp20.000</span>
                    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\app_paymin\resources\views/adminpage/report.blade.php ENDPATH**/ ?>
    ...
    <main class="flex items-center justify-between h-screen bg-[#E6EEFD] overflow-hidden font-poppins">
        ...
        <section class="h-full w-full p-11 box-border overflow-y-auto">
            <div class="mb-8 w-full shadow-4xl rounded-xl bg-linear-[90deg,_#FFFFFF,_#E6EEFD] p-7">
                ...
                <p class="text-textColor text-lg">{{ \Carbon\Carbon::now()->translatedFormat('l, j F Y') }}</p>
            </div>
                ...
                <form class="flex items-center gap-2">
                    <div class="relative w-full">
                        ...
                        <input type="text" placeholder="Search food, coffe, etc..." id="searchInput"
                            onkeyup="searchTable()" value="{{ old('search') }}"
                            class="border border-gray-300 rounded-2xl pl-10 pr-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-primary" />
                    </div>
                </form>
            </div>

            <div class="itemCard grid grid-cols-4 auto-rows-auto gap-4 justify-items-center p-4 relative w-full h-full"
                id="orderList">
                @foreach ($product as $p)
                <div
                    class="flex flex-col items-center justify-center bg-white shadow-4xl rounded-xl cursor-pointer transition-all duration-200 p-6 w-full h-[50vh] relative mt-10">
                    ...
                    <h2 class="item-name text-2xl font-semibold">{{ $p->name }}</h2>
        ...
        <!-- Modal Order Finish -->
        <div class="fixed hidden inset-0 flex items-center justify-center backdrop-blur-md bg-opacity-50 bg-opacity-50 z-100 w-full animate-fadeIn"
            id="modalOrderFinish">
            <div
                ...
                <div class="flex flex-col items-center justify-center w-full h-full my-auto">
                    <div class="w-48 h-48 bg-[#e2fff3] rounded-full flex items-center justify-center mb-5">
                        <div class="text-white w-24 h-24 bg-[#23A26D] rounded-full flex items-center justify-center">
                ...
                <div class="flex flex-col items-center w-full mt-2">
                    <div class="flex justify-between w-full h-[60px]">
                        <div class="flex items-center justify-center w-[5em]">
                            <img src="assets/src/assets/coffee.png" alt="Coffee" class="w-full object-cover h-full" />
                        </div>
                        <div class="w-auto">
                            <h1
            ...
            <div class="relative h-auto w-full flex flex-col justify-end bottom-0 p-6">
                <div class="flex justify-end mt-3 w-full">
                    <button
                        ...
                        type="button" id="continuePaymentBtn" onclick="showPaymentSuccessModal()">
                        Confirmation
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white w-[50%] h-auto rounded-xl shadow-lg p-6 space-y-4">
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button class="px-4 py-2 rounded-md bg-primary text-white hover:bg-primary"
                        onclick="showPaymentSuccessModal()">
                        Confirm
                    </button>
                </div>
            </div>

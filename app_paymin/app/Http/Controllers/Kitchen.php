...
class Kitchen extends BaseController
{
    ...
    public function home() {
        ...
        return view('kitchenpage/home',  compact('user', 'admissionFee', 'TotalItems', 'TotalCustomers', 'TotalCustomers', 'products', 'lowStocks', 'ordersToday', 'salesGrowth'));
    }

    // ORDER
    public function order() {

        $totalOrderReady = DB::table('sales')->where('status', 'procced')->count();
        ...
        $sales = Mdl_Sales::with('saleItems.sale.customer')->where('status', 'procced')->get();


        return view('kitchenpage/order',compact('totalOrderReady', 'totalOrderServed', 'sales'));
    }

    ...
    <main class="flex items-center justify-between h-screen bg-[#E6EEFD] overflow-hidden font-poppins">
        <nav id="navbar" class="bg-white h-full overflow-hidden w-[7.2rem] min-w-[7.2rem] p-5 shadow-4xl rounded-r-4xl">
            <ul id="navbar-list" class="flex flex-col h-full w-full relative z-10">
                ...
                <li
                    ...
                    <a href="{{ route('HomeKitchen') }}" class="flex flex-col items-center justify-center">
                ...
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="{{ route('OrderKitchen') }}" class="flex flex-col items-center justify-center">
                ...
                <li
                    class="flex flex-col items-center justify-center text-[#8B8B8B] hover:text-primary transition-all duration-300 ease-in-out h-[70px] relative z-20 cursor-pointer">
                    <a href="{{ route('SettingKitchen') }}" class="flex flex-col items-center justify-center">
        ...
        <section class="h-full w-full p-11 box-border overflow-y-auto">
            ...
            <div class="flex gap-4 py-6 w-full">
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    ...
                    <div class="p-6">
                        <p class="text-xs text-gray-500">Total Order Procces</p>
                        <p class="text-3xl font-bold text-gray-800">{{ $totalOrderProcces }} Items</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-4xl w-full">
                    <div class="h-2 bg-primary rounded-t-lg"></div>
                    <div class="p-6">
                        <p class="text-xs text-gray-500">Total Order Ready</p>
                        <p class="text-3xl font-bold text-gray-800">{{ $totalOrderReady }} Items</p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex flex-col items-center w-full h-full">
                                ...
                                <div class="flex flex-col items-center justify-center w-full mt-auto">
                                    ...
                                    <p class="text-[11pt] text-gray-500 mt-1">
                                        Rp.{{ $p->total }} <span class="mx-1">|</span> {{ $p->quantity }} Quantity
                                    </p>
                                </div>
        ...
        <div class="fixed inset-0 bg-black/25 backdrop-blur-md bg-opacity-50 justify-center items-center z-50 animate-fadeIn hidden"
            ...
            <div
                    ...
                    <div class="flex flex-col w-[55%] justify-between text-gray-800 text-sm">
                        <div class="space-y-4">
                            <div class="flex justify-between border-b pb-1">
                                <span>Cassier Name</span>
                                <span class="font-medium" id="modalCashierName"></span>
                            </div>
                            <div class="flex justify-between border-b pb-1">
                            ...
                            <div class="flex justify-between border-b pb-1">
                                ...
                                <span class="font-medium" id="modalItemList"></span>
                            </div>
                            <div class="border-b pb-1">
                                <span class="block mb-1">Order Note</span>
                                <p class="text-right font-medium leading-tight" id="modalItemDesc"></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 flex justify-end gap-x-4">
                    <!-- @foreach ($sales as $p) -->
                    <form action="{{ route('SysOrderKitchenUpdate') }}" method="POST">
                        @csrf
                        <input type="hidden" id="orderIdInput" name="order_id">
                        <button class="border-2 bg-primary text-white px-4 py-2 rounded " type="submit">
                            Submit Order
                        </button>
                    </form>
                    <!-- @endforeach -->

                        ...
                        <tbody id="tableBody">
                            ...
                            <tr class="border-b border-tertiary h-[3rem] text-center">
                                ...
                                <td class="p-3">
                                    ...
                                    @elseif ($md->role == 'cassier')
                                    <button class="bg-tertiary text-white py-2 px-6 cursor-pointer rounded-full">
                                        Cassier
                                    </button>
                                    @elseif ($md->role == 'kitchen')
                                    <button class="bg-tertiary text-white py-2 px-6 cursor-pointer rounded-full">
                                        Kitchen
                                    </button>
                                    @elseif ($md->role == 'waiters')
                                    <button class="bg-tertiary text-white py-2 px-6 cursor-pointer rounded-full">
                                        Waiters
                                    </button>
                                    @elseif ($md->role == 'storage')
                                    <button class="bg-tertiary text-white py-2 px-6 cursor-pointer rounded-full">
                                        Storage
                                    </button>
                                    @endif
                                    ...
                                    <form action="{{ route('SysEditMaster', $md->id) }}" method="post"
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select name="role"
                                                ...
                                                <option value="admin" {{ $md->role == 'admin' ? 'selected' : '' }}>
                                                    admin
                                                </option>
                                                <option value="cassier" {{ $md->role == 'cassier' ? 'selected' : '' }}>
                                                    cassier
                                                </option>
                                                <option value="kitchen" {{ $md->role == 'kitchen' ? 'selected' : '' }}>
                                                    kitchen
                                                </option>
                                                <option value="storage" {{ $md->role == 'storage' ? 'selected' : '' }}>
                                                    storage
                                                </option>
                                                <option value="waiters" {{ $md->role == 'waiters' ? 'selected' : '' }}>
                                                    waiters
                                                </option>
                                            </select>

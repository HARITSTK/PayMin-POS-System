            ...
            <div class="bg-white p-8 shadow-4xl h-[40em] w-full relative rounded-lg">
                ...
                <div class="w-full h-[33em] overflow-y-auto p-4">
                    <div class="grid grid-cols-4 lg:grid-cols-4 auto-rows-auto gap-10 justify-items-center"
                        ...
                        <div class="w-full h-full bg-white rounded-lg shadow-4xl card-container hidden">
                            <div class="flex flex-col items-center w-full h-full">
                                ...
                                <div class="w-full flex justify-between items-center mt-auto h-16">
                                    <button class="bg-primary h-full text-white text-lg w-full rounded-bl-lg"
            ...
            <div
                ...
                <div class="mt-4 flex justify-between gap-x-4 py-2">
                    ...
                    <div class="mt-4">
                        ...
                        <label for="itemStock" class="block text-sm font-medium text-gray-700 mt-4">Item Stock</label>
                        ...
                        <label for="itemPrice" class="block text-sm font-medium text-gray-700 mt-4">Item Price</label>
